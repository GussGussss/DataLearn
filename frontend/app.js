    ...
    niveles:[
      ...
      { titulo:'Nivel 2 — Recorridos', ejercicios:[
        ...
        { id:'mat_2_3', nombre:'Buscar un valor',
          enunciado:'Escribe buscar_en_matriz(matriz, valor) que retorne True/true si el valor existe en alguna celda.',
    ...
    niveles:[
      { titulo:'Nivel 1 — Fundamentos', ejercicios:[
        ...
        { id:'col_1_2', nombre:'Cola vacía',
          enunciado:'Escribe es_cola_vacia(cola) que retorne True/true si la cola no tiene elementos.',
    ...
    niveles:[
      { titulo:'Nivel 1 — Fundamentos', ejercicios:[
        ...
        { id:'arb_1_2', nombre:'Árbol vacío',
          enunciado:'Escribe es_arbol_vacio(raiz) que retorne True/true si la raíz es nula.',
        ...
        { id:'arb_1_3', nombre:'Es hoja',
          enunciado:'Escribe es_hoja(nodo) que retorne True/true si el nodo no tiene hijos.',
      ...
      { titulo:'Nivel 2 — Análisis', ejercicios:[
        { id:'arb_2_1', nombre:'Calcular la altura',
          enunciado:'Escribe calcular_altura(raiz) que retorne la altura. Vacío=0, recursivo: 1 + max(izq, der).',
      ...
      { titulo:'Nivel 3 — Recorridos', ejercicios:[
        { id:'arb_3_1', nombre:'Recorrido In-orden',
          enunciado:'Llena una lista con los valores en In-orden (izq → raíz → der).',
        ...
        { id:'arb_3_2', nombre:'Recorrido Pre-orden',
          enunciado:'Llena una lista en Pre-orden (raíz → izq → der).',
